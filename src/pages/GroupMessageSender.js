...
import ProgressBar from '../components/ProgressBar'; // Asegúrate de tener el componente de ProgressBar
import ConfirmationModal from '../components/ConfirmationModal';
import './GroupMessageSender.css';
      ...
      try {
        ...
        if (contactsResponse.status === 200) {
          ...
          if (response.status === 200) {
            ...
            setErrorMessage('Error al enviar los mensajes. Intenta nuevamente.');
          }
        } else {
        ...
        setErrorMessage(`Error al enviar los mensajes: ${error.message}`);
      } finally {
    ...
    <div className="group-message-sender-container">
      ...
      {isSending && (
        <div className="progress-bar-container">
          <ProgressBar percentage={progress} timeLeft={timeLeft} onPauseClick={handleAction} isPaused={isPaused} />
        </div>
      )}
