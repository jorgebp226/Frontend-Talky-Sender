  ...
  const fetchCompletionStatus = async () => {
    try {
      ...
      if (response.data) {
        ...
        let initialCompletedSteps = response.data.step1QR;
        if (response.data.step2message >= 1) {
          initialCompletedSteps += 1;
        }
        setStepsCompleted(initialCompletedSteps);
                    ...
                    <div className="message-step-content">
                      ...
                      <div className="whatsapp-image-container">
                        <div className="whatsapp-instructions">
                          ...
                          {step2Message === 0 ? (
                            <Link to="/send-messages" className="quick-action-button2">
                              Enviar Mensajes
                            </Link>
                          ) : (
                            <>
